...
It should be noted that while not a specific focus in this study, the effects that the sub-optimal tests have on the seasonal mean and threshold climatologies may also be of interested and so have been included in Appendix 2.
...
RWS: Figure 4DEF show the results of the time series length on the largest MHW in the time series but I didn't go over the results here as I felt the results section was getting too long...
...
RWS: A table that shows the slopes in the rates of change for the results.
...
RWS: An issue that needs to be discussed (according toa  reviewer) is how increased heat content of sub-surface waters makes MHWs below the surface appear to last longer or be larger etc.
...
2) Missing data:
  - Missing data up to 30% produces results as disimilar from a control time series as using 10 years of data does
...
Figure 6: The count of consecutive missing days of data.


Appendix 3A: The same global map as Figure 4, but with rates of change shown due to increasing mssing data from 0 -- 50%.
