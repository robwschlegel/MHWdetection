...
load("~/MHWdetection/analysis/data/sst_ALL_con.Rdata")
...
# This file is not uploaded to GitHub as it is too large
# One must first run the above code locally to generate and save the file
load("~/MHWdetection/analysis/data/sst_ALL_miss_clim_only.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_miss_clim_aov_tukey.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_miss_clim_KS_p.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_miss_event_aov_tukey.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_miss_event_CI.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_miss_clim_event_cat.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_miss_cat_chi.Rdata")
...
load("~/MHWdetection/analysis/data/sst_ALL_detrend.Rdata")
