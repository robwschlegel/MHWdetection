...
# Set Python results
res_event_Python <- read_csv("~/MHWdetection/analysis/data/mhws_py.csv")
res_clim_Python <- read_csv("~/MHWdetection/analysis/data/clim_py.csv")
```
...
sst_WA_miss_random <- read_csv("~/MHWdetection/analysis/data/sst_WA_miss_random.csv") %>% 
  dplyr::rename(temp = x) %>% 
...
# Load Python results
res_clim_random_Python <- read_csv("~/MHWdetection/analysis/data/clim_py_random.csv")
res_event_random_Python <- read_csv("~/MHWdetection/analysis/data/mhws_py_random.csv")
```
