...
ggplot(clim_tukey_sig, aes(x = miss_large, y = miss_small)) +
  # geom_point() +
...
```{r clim-miss-CI-plot, fig.cap="Confidence intervals of the seas and thresh for each missing data step for all three time series."}
