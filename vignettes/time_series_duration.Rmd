...
```{r event-box, fig.cap="Boxplots showing the spread of the values for the metrics of the events detected with the three different clim periods."}
...
```{r event-CI-plot, fig.cap="Confidence intervals of the different metrics for the three different clim periods from the population mean."}
...
```{r event-box, fig.cap="Boxplots showing the spread of the values for the metrics of the events detected with the three different clim periods re-sampled 100 times."}
# Long data.frame for plotting
...
```{r event-CI-plot, fig.cap="Confidence intervals of the different metrics for the three different clim periods from the population mean based on the 100 times re-sampling of each clim period in red, and the single sample based on the real data in black."}
