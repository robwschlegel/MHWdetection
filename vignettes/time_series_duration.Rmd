...
With the effect of shortening time series on the detection of events quantified, we will now perform [re-sampling](https://robwschlegel.github.io/MHWdetection/articles/Short_climatologies.html) to simulate one hundred time series at each length of 3 -- 34 years in order to more thoroughly quantify the effects of short time series. In addition to the statistica methods used in the previous section, this will also be measured through the following statistics:
...
The secondary goal of this step in this section of the methodology is to also identify how much more accurate this re-sampling may be able to make the climatologies generated from shorter time series.
